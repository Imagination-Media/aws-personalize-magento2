...
use ImaginationMedia\AwsPersonalize\Model\Export\Customer as ExportModel;
...
class Customer extends Command
{
    ...
    {
        $this->setName('aws:personalize:export:customers');
        $this->setDescription('Export customer to the AWS Personalize dataset.');
        parent::configure();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        try {
            $output->writeln("Preparing customer data to be exported...");
